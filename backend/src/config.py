...
class Config:
    ...
    MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'fer2013_mini_XCEPTION.102-0.66.hdf5')
    USE_DEEPFACE = True
